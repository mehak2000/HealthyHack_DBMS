...
<html>
  <head>
    <title> Explore | Healthy Hack </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Food Area </a></li>
...
?>
    ...
    <div class="carousel-inner">
      ...
      <img src="images/healthy1.jpg" style="width:100%;">
      <div class="carousel-caption">
      </div>
      </div>
      <div class="item">
      <img src="images/healthy2.jpg" style="width:100%;">
      <div class="carousel-caption">
      </div>
      </div>
      <div class="item">
      <img src="images/healthy3.jpg" style="width:100%;">
      <div class="carousel-caption">
      </div>
      </div>  
    </div>
...
/*
$R_namesql = "SELECT RESTAURANTS.name FROM RESTAURANTS, FOOD WHERE FOOD.food_ID=RESTAURANTS.R_ID";
...
<h5 class="text-info">Qty: <input type="number" min="1" max="25" name="quantity" class="form-control" value="1" style="width: 60px;"> </h5>

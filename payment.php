...
$gtotal = 0;
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (food_ID, foodname, price,  qty, order_date, username, R_ID) 
              VALUES ('" . $food_ID . "','" . $foodname . "','" . $price . "','" . $qty . "','" . $order_date . "','" . $username . "','" . $R_ID . "')";
